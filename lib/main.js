      ...
      lint: async (textEditor) => {
        ...
        return helpers.exec(atom.config.get('linter-packer-validate.packerExecutablePath'), args, {cwd: dir, ignoreExitCode: true}).then(output => {
          ...
          output.split(/\\r\\n\\n|\\n\\n/).forEach((line) => {
            ...
            // an error message with an asterisk may appear before file/line info
            else if (matchesExcerptAsterisk != null)
              theExcerpt = matchesExcerptAsterisk[1];
            // use final info with previous iterations' severity and file/line OR excerpt info
              ...
              if (matchesExcerpt != null)
                theExcerpt = matchesExcerpt[1];
