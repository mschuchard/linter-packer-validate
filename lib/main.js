...
export default {
  ...
  activate() {
    ...
    this.helpers.exec(atom.config.get('linter-packer-validate.packerExecutablePath'), ['--help']).then(output => {
      if (!(/init/.exec(output))) {
    ...
    return {
      ...
      lint: async (textEditor) => {
        ...
        if (atom.config.get('linter-packer-validate.usePackerFormat') || atom.config.get('linter-packer-validate.format.enabled')) {
          ...
          this.helpers.exec(atom.config.get('linter-packer-validate.packerExecutablePath'), fmtArgs, { cwd: dir }).catch(error => {
        ...
        return this.helpers.exec(atom.config.get('linter-packer-validate.packerExecutablePath'), args, { cwd: dir, env: packerEnv, ignoreExitCode: true }).then(output => {
